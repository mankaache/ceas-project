...
const SearchBar = () => {
    ...
    return (
        <form className='w-[60%] md:w-[35%] relative'>
            <div className="relative">
                <input type="search" placeholder='Type Here' className='w-full px-4 py-3 focus:border-none rounded-full bg-white border border-gray-700' onChange={(e) => handleSearch(e)}/>
